...
class UserController extends \BaseController {
	...
	public function store()
	{
		...
		if(!$checkUser):
			...
			return Redirect::to("admin/users/$checkUser->id")->with('successMessage', $successMessage);
		endif;
	...
	public function update($id)
	{
		...
		if($v->fails()):
			...
			if(Hash::check(Input::get('password'), $user->password)):
				...
				return Redirect::to("admin/users/$user->id")->with(array('user'=> $user, 'successMessage'=> $successMessage));
			endif;
		endif;
	}
	...
	public function destroy($id)
	{
		...
		if($deleteUser = User::find($id)->delete()):
			...
			$users = User::all();
			return Redirect::to('admin/users')->with(array('successMessage' => $successMessage, 'users' => $users));
